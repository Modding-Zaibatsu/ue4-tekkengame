...
int32 UMaterial::CompilePropertyEx( FMaterialCompiler* Compiler, EMaterialProperty Property )
{
	...
	switch (Property)
	{
		...
		case MP_Anisotropic:				return Anisotropic.CompileWithDefault(Compiler, Property);
		case MP_LightChannel:				return LightChannel.CompileWithDefault(Compiler, Property);
